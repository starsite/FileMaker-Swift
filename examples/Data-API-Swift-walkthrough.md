...
The example below includes a basic find request. Visit the DataAPI.swift class (https://github.com/starsite/FileMaker-Swift/blob/master/DataAPI.swift) for other options (CRUD).
 - - -
