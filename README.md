...
I like to fetch my environment settings from CloudKit, in `application(_:didFinishLaunchingWithOptions)` or `applicationWillEnterForeground()`. Doing it this way also provides a remote kill-switch, if necessary.
