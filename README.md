...
This `README.md` is aimed at FileMaker devs who want to integrate the Data API into their Xcode projects. Each function is paired with a code example. Everything in this readme is part of `DataAPI.swift`, in this repo.
